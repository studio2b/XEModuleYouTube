...
//12AUG2021(1.0.1.) - "$token_type" parameter is added to XFYoutubeChannels method. Array keys are wrapped with double quotation marks("").
class XFYoutubeChannels {
	var $api_key, $token, $token_type;
	var $apiUri = "https://www.googleapis.com/youtube/v3/channels";

	function XFYoutubeChannels($token=NULL, $api_key=NULL, $token_type=NULL) {
